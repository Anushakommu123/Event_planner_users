...
import '../customer/Login.css'; // Reuse the same styles
            ...
            <div className="login-split">
                ...
                <div className="login-brand">
                    <div className="brand-content">
                        ...
                        <h2 className="brand-tagline">Vendor Portal</h2>
                        <p className="brand-description">
                            Manage your services, bookings, and grow your event business with our comprehensive vendor dashboard.
                        </p>
                    ...
                    <div className="login-form-container">
                        ...
                        <form onSubmit={handleSubmit} className="login-form">
                            ...
                            <p className="signup-prompt">
                                ...
                                <Link to="/vendor/signup" className="signup-link">Register as Vendor</Link>
                            </p>
